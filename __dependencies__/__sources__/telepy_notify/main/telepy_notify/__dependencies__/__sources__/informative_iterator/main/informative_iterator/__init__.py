...
class ProgressBar:
    ...
    percent_per_print = 2
    minutes_per_notify = 60
    percent_per_notify = 10
    lookback_size = 100
    time_format = "%H:%M:%S"
    ...
    def __init__(self, iterator, *, title=None, iterations=None, layout=None, disable_logging=None, minimal=None, inline=None, progress_bar_size=None, seconds_per_print=None, percent_per_print=None, minutes_per_notify=None, percent_per_notify=None, lookback_size=None, smoothing_buffer_size=5, smoothing_threshold_in_seconds=2, notify_delay=1):
        ...
        for each_option in [ "disable_logging", "minimal", "inline", "progress_bar_size", "seconds_per_print", "percent_per_print", "minutes_per_notify", "percent_per_notify", "lookback_size" ]:
        ...
        # if only given minutes_per_notify, then clear the default percent_per_notify
        if minutes_per_notify != None and percent_per_notify == None:
            self.percent_per_notify = 100
        # if only given percent_per_notify, then clear the default minutes_per_notify
        if percent_per_notify != None and minutes_per_notify == None:
        ...
        self.percent_at_prev_notify   = 0 
        self.time_at_prev_print    = -math.inf
        self.time_at_prev_notify   = -math.inf
        ...
        def generator_func():
            ...
            for iter_index, each_original in enumerate(original_generator):
                ...
                percent_since_prev_notify  = percentage_complete - self.percent_at_prev_notify
                seconds_since_prev_print   = current_timestamp - self.time_at_prev_print
                seconds_since_prev_notify  = current_timestamp - self.time_at_prev_notify
