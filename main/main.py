            ...
            try:
                ...
                def env_snapshot(env):
                    return deepcopy(dict(
                        ...
                        original_relative_spin=                        getattr(env, "original_relative_spin"                        , None),
                        action=                                        getattr(env, "action"                                        , None),
                        absolute_action=                               getattr(env, "absolute_action"                               , None),
                        reaction=                                      getattr(env, "reaction"                                      , None),
                        prev_absolute_action=                          getattr(env, "prev_absolute_action"                          , None),
