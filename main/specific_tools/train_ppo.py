...
with notifier.when_done:
    waypoint_path_options = [ 
        "/sim_remote_waypoint.csv", "/sim_remote_waypoint.csv", "/sim_remote_waypoint.csv",  "/sim_remote_waypoint.csv", "/sim_remote_waypoint.csv", "/sim_remote_waypoint.csv",  "/sim_remote_waypoint.csv", "/sim_remote_waypoint.csv", "/sim_remote_waypoint.csv", "/sim_remote_waypoint.csv", "/sim_remote_waypoint.csv", 
        "/concrete1.csv",  "/concrete1.csv",  "/concrete1.csv", 
        "/straight_line.csv",
    ]
    ...
    def ppo(env, seed, buff_size, train_time_steps, gamma, clip_ratio, lr_pi, lr_vf, pi_train_itrs, v_train_itrs, lam, max_ep_len):
        ...
        progress_notifications = iter(notifier.progress(train_time_steps, seconds_per_print=60*60*3, percent_per_print=10))
