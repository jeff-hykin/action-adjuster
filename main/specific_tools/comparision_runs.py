...
finished = 0
number_of_data_points_per_scenario = 15
for run_number in range(finished, number_of_data_points_per_scenario):
    ...
    for each_profile in [ "@NORMAL_ADJUSTER", "@NO_ADJUSTER", "@PERFECT_ADJUSTER", ]:
        ...
        output_folder = f"{path_to.records}/3.{each_profile}|noise=none|{run_number_string}.ignore"
        profiles = [ each_profile, "@WARTHOG", "@NOISE=NONE", "@ADVERSITY=WEAK" ]
